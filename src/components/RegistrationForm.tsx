...
export default function RegistrationForm() {
  ...
  async function handleSubmit(e: any) {
    ...
    console.log(
      `Email : ${email}, password : ${password}, role : ${role}, country : ${country}, username : ${username}`
    );
  ...
  return (
    <Container onSubmit={handleSubmit}>
      ...
      {!emailRef?.current?.value && !showForm ? (
        <RegisterContainer>
          <EmailField>
          ...
          <Fine>
            By registering, you agree to be respectful to others and not sue IBC
            Media
          </Fine>
        </RegisterContainer>
      ) : (
        <>
          ...
          <EmailField>
            ...
            <EmailInput ref={lastNameRef} type="text" required id="lastname" />
          </EmailField>
          <EmailField>
            <EmailField>
              <EmailLabel htmlFor="emailInput">EMAIL</EmailLabel>
            ...
            <EmailLabel htmlFor="emailInput">CHOOSE COUNTRY</EmailLabel>

            <select
              ref={countryRef}
              className="rounded-md p-2.5 h-10 outline-none
  dark:bg-dark-400 dark:text-text-tertiary"
          ...
          <EmailField>
            <EmailLabel htmlFor="emailInput">CHOOSE ROLE</EmailLabel>
  ...
  dark:bg-dark-400 dark:text-text-tertiary"
            ...
            >
              ...
              <option value="5">Startup SME</option>
              <option value="6">Investor</option>
              <option value="7">Corporate Professional</option>
            </select>
          </EmailField>
